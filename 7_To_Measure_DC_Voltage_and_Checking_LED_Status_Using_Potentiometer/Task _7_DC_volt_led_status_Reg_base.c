...
***************************************************************************************
  ...
  when voltage greater than 2 volt it should turn off*
***************************************************************************************/
//header files
#include <stdio.h>
#include <string.h>
...
void main(void)
{
    ...
    while (1)
    {
        ...
        // If ADC value is less than 2volt then toggle the LED1
...
void Timer_Delay()
{
    ...
    InitCpuTimers();
    // Configure Timer 0 with a period of DELAY 500 milliseconds
    ConfigCpuTimer(&CpuTimer0, 200, 100000);
    // Start Timer 0
    StartCpuTimer0();
    // Wait until Timer 0 times out
